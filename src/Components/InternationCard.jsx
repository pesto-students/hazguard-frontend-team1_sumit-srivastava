const InternationCard = () => {
	return (
		<div className="sxl:w-[100%] sxl:mt-[30px] md:w-[80%] md:mt-0 sxl:h-[500px] md:h-[80%] bg-gradient-to-tl from-[#180F55,60%] to-[#6A718F] rounded-[20px] flex flex-col justify-between items-center pb-[50px]">
			<div className="w-[100%] h-[60px] bg-[#272343] rounded-t-[20px] flex justify-center items-center font-[700] text-[#fff] sxl:text-[18px] md:text-[20px]">International Subscription</div>
			<div className="sxl:text-[20px] md:text-[30px] text-[#fff]">
				<span className="text-[Baloo] font-[400] sxl:text-[50px] md:text-[100px] text-[#fff]">49</span>$
			</div>
