...
const SinglePost = ({ data, fromMyPosts }) => {
	...
	return (
		<div className="w-[100%] p-3 sxl:h-[180px] md:h-[170px] min-h-[250px] max-h-[200px] first:mt-[0px] mt-[10px] bg-[#fff] rounded-[20px] flex flex-col items-center justify-center text-ellipsis mb-3">
			...
			<div className="w-[100%] mb-4 max-h-[100px] my-[5px] h-[250px] px-3 flex justify-start items-start text-[#272343] font-[500] sxl:text-[12px] sm:text-[16px] md:text-[17px] break-words text-ellipsis sxl:leading-[12px] sm:leading-[20px] overflow-scroll border-2 border-solid border-red-400">
				{data.problem}
			</div>
