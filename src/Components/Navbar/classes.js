export const classes = {
	navContainer: {
		...
		navbar: {
			body: `flex no:w-[100%] md:w-[80%] h-[120px] bg-[#272343] rounded-[20px] overflow-hidden flex-none`,
	...
	profileBoard: {
		body: ` no:hidden md:flex h-[120px] ml-[30px] bg-white rounded-[20px] overflow-hidden w-[20%]`,
	},
};
