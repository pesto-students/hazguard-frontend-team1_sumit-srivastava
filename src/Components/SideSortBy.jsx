	...
	return (
		<div className="w-[100%] h-[80%]">
			...
			<div className="w-[100%] h-[50%] flex flex-col justify-center items-starts">
				<div className="font-[700] text-[15px] text-[#272343]">Rankings</div>
				<div className="flex font-[700] text-[13px] text-[#677094] justify-between w-[100%]">
					<div>Rank</div>
					<div>Industry</div>
					<div>Posts</div>
				</div>
				<div className="flex font-[700] text-[11px] text-[#fff] justify-between w-[100%] bg-[#677094] mt-[5px] px-[5px] py-[5px] max-h-[25px]">
					<div>1</div>
				...
				<div className="font-[700] text-[14px]  text-[#677094]">Your rank: 03</div>
			</div>
		</div>
	);
};
