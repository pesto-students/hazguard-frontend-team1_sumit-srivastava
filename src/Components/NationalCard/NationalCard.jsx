...
const NationalCard = () => {
	return (
		<div className=" no:w-[100%] no:mt-[30px] md:w-[48%] md:mt-0 no:h-[500px] md:h-[100%] bg-gradient-to-tl from-[#180F55,60%] to-[#6A718F] rounded-[20px] flex flex-col justify-between items-center pb-[50px]">
			<div className="w-[100%] h-[60px] bg-[#272343] rounded-t-[20px] flex justify-center items-center font-[Arial] font-[700] text-[#fff] no:text-[18px] md:text-[20px]">National Subscription</div>
