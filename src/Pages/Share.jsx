				...
				<div className="w-[100vw] h-[100vh] flex flex-col justify-center items-center mt-[30px] pb-[30px]">
					<div className="w-[100%] h-[calc(100%)] flex justify-center items-center no:px-[15px] md:px-[30px] no:flex-wrap md:flex-nowrap">
						<div className="no:w-[100%] md:w-[50%] h-[100%] bg-[#fff] rounded-[20px] no:mb-[15px] md:mb-[0px] md:mr-[15px] px-[20px] py-[20px] flex justify-center items-center flex-col">
							<div className="font-[Arial] font-[700] text-[#272343] text-[20px] mb-[30px] self-start">Hazard Information</div>
							<form action="" className="w-[100%] h-[100%] flex flex-col justify-start items-center">
								<div className="w-[90%] flex flex-col justify-center items-start mb-[30px]">
									<label htmlFor="type" className="font-[Arial] font-[400] text-[#272343] text-[18px]">
										Hazard Type<span className=" text-red-600">*</span>
									</label>
									<select
										name="type"
										id="type"
										className="border-[1px] border-solid border-[#272343] w-[100%] h-[40px] text-center font-[Arial] font-[700] text-[#677094] text-[15px] cursor-pointer"
									>
										<option
											value=""
											defaultChecked
								...
								<div className="w-[90%] flex flex-col justify-center items-start mb-[30px]">
									<label htmlFor="level" className="font-[Arial] font-[400] text-[#272343] text-[18px]">
								...
								<div className="w-[90%] flex flex-col justify-center items-start mb-[30px]">
									...
									<input
										type="text"
										id="type"
										className={`$"border-[1px] border-solid border-[#272343] w-[100%] h-[40px] text-center font-[Arial] font-[700] text-[#677094] text-[15px] cursor-pointer" cursor-text`}
									/>
								</div>
								<button
									type="save"
									className="self-center bg-[#EED132] w-[150px] h-[40px] rounded-[20px] font-[Arial] font-[700] text-[#fff] text-[20px] hover:bg-[rgba(238,209,50,0.8)]"
								>
									Save
								</button>
							</form>
						...
						<div className="no:w-[100%] md:w-[50%] h-[100%] bg-[#fff] rounded-[20px] no:mt-[15px] md:mt-[0px] md:ml-[15px] px-[20px] py-[20px] flex flex-col justify-start items-center">
							<div className="font-[Arial] font-[700] text-[#272343] text-[20px] mb-[30px] self-start">Hazardous Problem and Solution</div>
							<div className="w-[100%] flex flex-col justify-center items-center mb-[30px]">
								<label htmlFor="problem" className="self-start font-[Arial] font-[400] text-[#272343] text-[18px]">
								...
								<textarea
									...
									className="border-[1px] border-solid border-[#272343] w-[100%] max-h-[200px] px-[10px] py-[10px] font-[Arial] font-[500] text-[#677094] text-[20px]"
								></textarea>
							</div>
							<div className="w-[100%] flex flex-col justify-center items-center mb-[30px]">
								<label htmlFor="solution" className="self-start font-[Arial] font-[400] text-[#272343] text-[18px]">
